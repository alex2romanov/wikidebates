            ...
            while True:
                ...
                if result['edit']['result'] == 'Failure':
                    if 'captcha' in result['edit']:
                        ...
                        if captcha['type'] in ['question']:
                            if captcha['question'] == "Quelle est l'encyclopédie collaborative mondialement connue de laquelle s'inspire Wikidébats ?":
                                req['captchaword'] = 'wikipedia'
                            elif captcha['question'] == "Wikidébats est une encyclopédie de... ?":
                                req['captchaword'] = 'debats'
                            else:
                                req['captchaword'] = input(captcha['question'])
                            continue
